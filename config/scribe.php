...
return [
    ...
    'laravel' => [
        ...
        'middleware' => [
            // Staff only. The docs describe every endpoint and its gates —
            // useful to an integrator, a gift to a stranger.
            'web',
            'auth',
        ],
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'Get a token from <code>POST /api/v1/auth/token</code> with your email, password and a device name. Access follows your account\'s permissions — see docs/roles-and-permissions.md.',
    ],
    ...
    'strategies' => [
        ...
        'responses' => configureStrategy(
            ...
            Strategies\Responses\ResponseCalls::withSettings(
                // Never let doc generation fire real requests into the live
                // database — the @response examples in the controllers are
                // hand-verified against real output instead.
                only: [],
